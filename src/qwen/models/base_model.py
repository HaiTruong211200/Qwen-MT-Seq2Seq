...
from qwen.models.modules.layers import QwenEncoderLayer, QwenDecoderLayer

logger = logging.get_logger(__name__)

Qwen_START_DOCSTRING = r"""
...
@add_start_docstrings(
    "The bare Qwen Model outputting raw hidden-states without any specific head on top.",
    Qwen_START_DOCSTRING,
)
...
class QwenModel(QwenPreTrainedModel):
    ...
    def __init__(self, config: Qwen2Config, is_causal=True):
        ...
        if is_causal:
            ...
            self.layers = nn.ModuleList(
                [QwenEncoderLayer(config, layer_idx) for layer_idx in range(config.num_hidden_layers)]
            )
